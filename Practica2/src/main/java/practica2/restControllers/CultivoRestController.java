...
public class CultivoRestController {
	...
	public void init() {
		...
		ProductoFitosanitario prod13 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		ProductoFitosanitario prod14 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		ProductoFitosanitario prod15 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		ProductoFitosanitario prod16 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		ProductoFitosanitario prod17 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		ProductoFitosanitario prod18 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		ProductoFitosanitario prod19 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		ProductoFitosanitario prod20 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		ProductoFitosanitario prod21 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		ProductoFitosanitario prod22 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		ProductoFitosanitario prod23 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		ProductoFitosanitario prod24 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		ProductoFitosanitario prod25 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		ProductoFitosanitario prod26 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		ProductoFitosanitario prod27 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		ProductoFitosanitario prod28 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		ProductoFitosanitario prod29 = new ProductoFitosanitario("PRODUCTAKO", "productaco.com");
		...
		Plaga p1 = new Plaga("Plaga de cannabis", "Plagus canabidus", "nose.com",sustancias1);
		Plaga p2 = new Plaga("Plaga de cannabis", "Plagus canabidus", "nose.com",sustancias2);
		Plaga p3 = new Plaga("Plaga de cannabis", "Plagus canabidus", "nose.com",sustancias3);
		Plaga p4 = new Plaga("Plaga de cannabis", "Plagus canabidus", "nose.com",sustancias4);
		Plaga p5 = new Plaga("Plaga de cannabis", "Plagus canabidus", "nose.com",sustancias5);
